...
import { setItems, selectItems } from "../../store/slices/idsSlice";
...
//    request(_api, "POST", JSON.stringify(_getIds)).then(res => {
//      setIds(res.result);
//    });
//  }, [offset, ids])
...
//      </select>
//      {renderProducts()}
//      <button onClick={handlePageChangePrev}>
//        Previous Page
//      </button>
//      <span>{currentPage}</span>
//      <button onClick={handlePageChangeNext}>
//        Next Page
//      </button>
//    </div>
//  );
